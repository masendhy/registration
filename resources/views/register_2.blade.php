...
<head>
    ...
    <title>Registration Form | Seleksi Pelatihan Masyarakat PPSDM Migas</title>
        ...
        <div class="card card-outline card-primary ">
            ...
            <div class="card-body">
                ...
                <form action="/registeruser" method="post">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" name='jenis_kelamin' placeholder="jenis_kelamin">
                        <div class="input-group-append">
                            <div class="input-group-text">
                                <span class="fas fa-user-circle"></span>
                            </div>
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" name='c' placeholder="ijazah">
                        <div class="input-group-append">
                            <div class="input-group-text">
                                <span class="fas fa-user-circle"></span>
                            </div>
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" name='surat_sehat' placeholder="surat_sehat">
                        <div class="input-group-append">
                            <div class="input-group-text">
                                <span class="fas fa-user-circle"></span>
                            </div>
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" name='form_daftar' placeholder="form_daftar">
                        <div class="input-group-append">
                            <div class="input-group-text">
                                <span class="fas fa-user-circle"></span>
                            </div>
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" name='surat_pernyataan'
                            placeholder="surat_pernyataan">
                        <div class="input-group-append">
                            <div class="input-group-text">
                                <span class="fas fa-user-circle"></span>
                            </div>
